...
fout = open('3layers_batch_normalization.txt', 'w')
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # Kernel: 3 x 3, Stride: (1, 1), output 6 layers, padding = 0 px
        ...
        # Kernel: 3 x 3, Stride: (1, 1), output 16 layers, padding = 0 px
        # So output size = 13 x 13 x 16 = 2704
        self.conv2 = nn.Conv2d(15, 75, 3)

        # Kernel: 3 x 3, Stride: (3, 3)
        ...
        self.batchNormalization15 = nn.BatchNorm2d(15)
        ...
        # self.fc1 = nn.Linear(23000, 10000)
        # self.fc2 = nn.Linear(10000, 4800)
        # self.fc3 = nn.Linear(4800, 2400)
        # self.fc4 = nn.Linear(2400, 800)
        # self.fc5 = nn.Linear(800, 400)
        # self.fc6 = nn.Linear(400, 120)
        # self.fc7 = nn.Linear(120, 84)
        # self.fc8 = nn.Linear(84, 10)

        # self.fc1 = nn.Linear(15000, 12000)
        ...
        self.fc1 = nn.Linear(375, 120)
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10)

    def forward(self, x):
        x = self.activation(self.conv1(x))
        x = self.batchNormalization15(x)
        x = self.pool1(x)
        # x = self.dropout10(x)
